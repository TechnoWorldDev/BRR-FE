...
import PlanQuizWrapper from "@/components/web/PlanQuiz/PlanQuizWrapper";
...
export const metadata: Metadata = generatePageMetadata({
  ...
  data: {
    title: "Pricing",
    description:
      "We are a team of experts who are passionate about helping people find the best branded residences. We use a combination of data and expert insights to assess the quality of each residence.",
    slug: "pricing",
              ...
              <div className="flex flex-col gap-[16px] w-full ">
                <div className="flex flex-col lg:flex-row gap-[16px]">
                  ...
                  <div className="flex-1 bg-white p-[24px] rounded-xl">
                    ...
                    <p className="text-black/50 text-[14px]">
                      Secure a spot in the top branded residences in your
                      country, increasing your appeal to both lo.
                    </p>
                  </div>
                </div>
                <div>
                  <div className="flex flex-col lg:flex-row gap-[16px]">
                    <div className="flex-1 bg-white p-[24px] rounded-xl">
                      ...
                      <p className="text-black/50 text-[14px]">
                        Rank your property in lifestyle categorie.g.,
                        beachfront, urban, eco-friendly) to reach buyers ank
                        your property in lifestyle categorie.g., beachfront,
                        urban, eco-friendly) to reach buyers
                      </p>
                    </div>
                    <div className="flex-1 bg-white p-[24px] rounded-xl">
