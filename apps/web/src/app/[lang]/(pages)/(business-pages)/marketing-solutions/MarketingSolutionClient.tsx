            ...
            <div className="flex flex-col xl:flex-row justify-between z-10 gap-[50px] ">
              <div className="flex flex-col justify-center gap-[16px]">
                ...
                <p className="text-[18px] text-white/60">
                  ...
                  actively seeking their next high-end property, helping you
                  close deals faster and with confidence.
                </p>
      ...
      <AlertDialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This marketing solutions page is specifically designed for
              developers and real estate professionals. As a buyer, you don't
              have access to these developer-specific features.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
