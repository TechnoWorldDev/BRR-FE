...
export const metadata: Metadata = generatePageMetadata({
  ...
  data: {
    title:
      "Best Branded Residences: Rankings & Reviews by Country, City, & Lifestyle",
    description:
      "We review & rate the world’s Best Branded Residences, from Miami to Dubai. Verified properties globally by country, city, lifestyle, or investment opportunities",
    keywords: [
      "luxury residences",
      "branded residences",
      "real estate",
    ...
    <>
      <div className="flex flex-col items-center rounded-b-xl bg-secondary max-w-[calc(100svw-1.5rem)] 2xl:max-w-[calc(100svw-4rem)] mx-auto px-4 lg:px-12 py-6 lg:py-12 gap-4 xl:gap-8 mb-3 lg:mb-12">
        <div className="w-full xl:max-w-[1600px] mx-auto flex flex-col lg:items-center gap-2 lg:gap-6">
          <h1 className="text-4xl lg:text-6xl font-bold w-full xl:w-[80%] text-left lg:text-center mt-0 lg:mt-8">
      ...
      <div className="flex flex-col lg:flex-row gap-4 xl:max-w-[1600px] mx-auto px-4 lg:px-12 py-12 gap-4 xl:gap-8 mb-12 ">
        <div className="flex flex-col items-center justify-center w-full lg:w-1/4">
          ...
          <p className="text-md lg:text-lg">{dictionary.stats.propertiesRanked}</p>
        </div>
        <div className="flex flex-col items-center justify-center w-full lg:w-1/4">
          <h2 className="text-4xl font-bold">150+</h2>
          <p className="text-md lg:text-lg">{dictionary.stats.rankingCategories}</p>
        </div>
        <div className="flex flex-col items-center justify-center w-full lg:w-1/4">
          <h2 className="text-4xl font-bold">100</h2>
          <p className="text-md lg:text-lg">{dictionary.stats.luxuryBrands}</p>
        </div>
        <div className="flex flex-col items-center justify-center w-full lg:w-1/4">
          <h2 className="text-4xl font-bold">5.0</h2>
          <p className="text-md lg:text-lg">{dictionary.stats.starRatings}</p>
        </div>
      </div>
        ...
        <SectionLayout>
          <div className="flex flex-col gap-4 w-full">
            <span className="text-md lg:text-lg text-left lg:text-center text-primary w-full">
              {dictionary.rankingCriteria.title}
            </span>
            <h2 className="text-4xl font-bold w-[100%] lg:w-[60%] text-left lg:text-center mx-auto">
              {dictionary.rankingCriteria.heading}
            </h2>
            <p className="text-md lg:text-lg w-full lg:w-[60%] text-left lg:text-center mx-auto text-white/70">
              {dictionary.rankingCriteria.description}
            </p>
          </div>
          <div>
            <div className="flex flex-col lg:flex-row gap-4 mt-8 max-w-[85%] xl:max-w-[1600px] mx-auto">
              <div className="flex flex-row gap-4 items-center w-full">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p>
                    Buying a branded residence is a significant investment—our
                    rankings help you make the best choice with confidence.
                  </p>
                </div>
              </div>
              <div className="flex flex-row gap-4 items-center w-full">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p>
                    Our ranking system is built on comprehensive research,
                    expert reviews, and buyer insights, offering a transparent,
                    data-backed evaluation process.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col lg:flex-row gap-4 mt-4 border rounded-2xl p-6 relative w-full xl:max-w-[1600px] mx-auto">
            <Image
              src="/ranking-criteria-1.webp"
              alt="Ranking Image"
              width={1000}
              height={1000}
              className="w-full lg:max-w-[32.5%] flex-1 rounded-lg object-cover"
            />
            <Image
              src="/ranking-criteria-2.webp"
              alt="Ranking Image"
              width={1000}
              height={1000}
              className="w-full lg:max-w-[32.5%] flex-1 rounded-lg object-cover"
            ...
            <Image
              ...
              width={1000}
              height={1000}
              className="w-[55%] rounded-xl object-contain absolute -bottom-10 left-1/2 transform -translate-x-1/2"
            />
          </div>
        </SectionLayout>
      </section>
        ...
        <SectionLayout className="bg-secondary rounded-2xl">
          <div className="flex flex-col gap-4 lg:gap-8 xl:gap-12 items-center px-4 py-12 lg:px-0 lg:py-0">
            <div className="flex flex-col gap-4">
              ...
              <p className="text-md lg:text-lg w-full lg:w-[60%] text-left lg:text-center mx-auto text-white/70">
                From iconic penthouses to high-ROI investments, explore
                properties ranked by trust, quality, and long-term value.
              </p>
            </div>
            <div className="new-solution-section-content grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="flex flex-col justify-center w-full bg-zinc-500/10 rounded-2xl p-6">
                <div className="flex flex-row gap-4 items-center mb-4">
                  <div className="relative">
                    ...
                    >
                      <path
                        d="M42 42H15.6C12.2397 42 10.5595 42 9.27606 41.346C8.14708 40.7708 7.2292 39.8529 6.65396 38.7239C6 37.4405 6 35.7603 6 32.4V6M12 30L20 22L28 30L40 18M40 18V26M40 18H32"
                        stroke="white"
                        strokeWidth="2.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                ...
                <p>
                  Access ROI projections, rental yield reports, and market
                  trends to make smarter buying decisions.{" "}
                </p>
              </div>
              ...
              <div className="flex flex-col justify-center w-full bg-zinc-500/10 rounded-2xl p-6">
                <div className="flex flex-row gap-4 items-center mb-4">
                  <div className="relative">
                    ...
                    >
                      <path
                        d="M10.0012 14V22M20.0012 4V12M36.0012 32V40M6.00116 18H14.0012M16.0012 8H24.0012M32.0012 36H40.0012M28.0012 14L33.658 19.6569M39.0344 7.49223L40.1658 8.6236C40.9578 9.41564 41.3538 9.81166 41.5022 10.2683C41.6327 10.67 41.6327 11.1027 41.5022 11.5044C41.3538 11.961 40.9578 12.3571 40.1658 13.1491L13.0521 40.2628C12.2601 41.0548 11.8641 41.4508 11.4074 41.5992C11.0057 41.7297 10.573 41.7297 10.1713 41.5992C9.71467 41.4508 9.31866 41.0548 8.52662 40.2628L7.39525 39.1314C6.60322 38.3394 6.2072 37.9433 6.05882 37.4867C5.92831 37.085 5.92831 36.6523 6.05882 36.2506C6.2072 35.794 6.60322 35.3979 7.39525 34.6059L34.5089 7.49224C35.301 6.7002 35.697 6.30418 36.1536 6.15581C36.5553 6.02529 36.988 6.02529 37.3897 6.15581C37.8464 6.30418 38.2424 6.7002 39.0344 7.49223Z"
                        stroke="white"
                        strokeWidth="2.5"
                        strokeLinecap="round"
                        strokeLinejoin="round"
              ...
              <div className="flex flex-col justify-center w-full bg-zinc-500/10 rounded-2xl p-6">
                ...
                <p>
                  ...
                  connect buyers, investors, and developers with curated
                  listings - ensuring a seamless, personalized experience.{" "}
                </p>
              </div>
              ...
              <div className="flex flex-col justify-center w-full bg-zinc-500/10 rounded-2xl p-6">
                ...
                <p>
                  Discover the Top 10 luxury homes, best high-rise investments,
                  and top waterfront properties.{" "}
                </p>
              </div>
            </div>
          </div>
        ...
        <SectionLayout>
          <div className="flex flex-col lg:flex-row gap-4 lg:gap-8 xl:gap-24 items-center px-4 py-12 lg:px-0 lg:py-0 xl:max-w-[1600px] mx-auto">
            <div className="w-full">
              <span className="text-md lg:text-lg text-left lg:text-left text-primary">
                MATCHMAKING TOOL
              </span>
              <h2 className="text-4xl font-bold text-left mx-auto mb-4 mt-4 w-full">
                AI Matchmaking Tool – Find Your Perfect Fit
              </h2>
              <p className="text-md mb-4 text-white/70">
                Answer a few quick questions, and let our AI match you with
                residences that fit your lifestyle and investment goals.
              </p>
            ...
            <div className="w-full border rounded-xl p-4">
              <Image
                src="/matchmaking-tool-section.webp"
                width={1000}
                height={1000}
                alt="matchmaking-tool"
              />
            </div>
          </div>
        </SectionLayout>
        ...
        <SectionLayout>
          <div className="flex flex-col-reverse lg:flex-row gap-4 lg:gap-8 xl:gap-24 items-center px-4 py-12 lg:px-0 lg:py-0 xl:max-w-[1600px] mx-auto">
            <div className="w-full relative">
              <Image
                src="/exclusive-offers-badges.webp"
                width={500}
                height={500}
                className="w-[50%] h-[50%] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"
                alt="exclusive-offers-badges"
              />
              <Image
                src="/exclusive-offers-section.webp"
                width={1000}
                height={500}
                className="w-full h-full"
                alt="exclusive-offers-section"
              />
            </div>
            <div className="w-full">
              <span className="text-md lg:text-lg text-left lg:text-left text-primary">
              ...
              <p className="mb-4 text-white/70">
                We've partnered with your favourite developers to get you
                exclusive offers on their inventory available only to our
                buyers.
              </p>
              <Link
                href="/exclusive-deals?page=1"
                className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all bg-primary text-primary-foreground shadow-xs hover:bg-primary/90 h-9 px-4 py-2 has-[>svg]:px-3 w-full lg:w-fit m-auto"
              >
                Get exclusive deals
          ...
          <div className="border rounded-xl p-4 lg:py-8 flex flex-col lg:flex-row gap-8 xl:max-w-[1600px] mx-auto">
            <div className="w-full lg:flex lg:flex-col">
              <div className="flex flex-col">
                ...
                <h2 className="text-4xl font-bold text-left mx-auto mb-4 mt-4 w-full capitalize">
                ...
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all bg-primary text-primary-foreground shadow-xs hover:bg-primary/90 h-9 px-4 py-2 has-[>svg]:px-3 w-full lg:w-fit mt-4"
                >
          ...
          <div className="flex flex-col items-start items-center gap-4 bg-[#FAF3EE] rounded-2xl p-6 lg:py-12 relative xl:max-w-[1600px] mx-auto">
            <div className="logo-badge">
              <Image
                ...
                width={220}
                height={220}
                className="absolute w-32 h-32 -top-8 -right-2 lg:w-[220px] lg:h-[220px] md:-top-12 lg:-right-12"
              />
            </div>
            <span className="text-md lg:text-lg text-left lg:text-center text-primary w-full text-[#C29970]">
              FOR DEVELOPERS
            </span>
            <h2 className="text-4xl font-bold w-[100%] lg:w-[50%] text-left lg:text-center mx-auto text-[#101518]">
              List Your Residence & Get Ranked Among the Best
            </h2>
            <p className="text-md lg:text-md w-full lg:w-[65%] text-left lg:text-center mx-auto text-[#1A1E21]">
              Is your luxury residence one of the finest in the world? Elevate
              its prestige by securing a spot on Best Branded Residences. Our
              expert-driven rankings and reviews showcase top-tier residences to
              discerning buyers, investors, and luxury connoisseurs.
            </p>
