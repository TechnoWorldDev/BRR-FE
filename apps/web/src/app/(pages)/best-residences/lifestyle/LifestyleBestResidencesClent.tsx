  ...
  const fetchData = useCallback(
    async (page: number) => {
      ...
      try {
        ...
        if (!response.ok) {
          throw new Error(
            `Failed to fetch lifestyle categories: ${response.status}`
          );
        }
    ...
    return (
      <div>
        <div className="flex flex-col items-center rounded-b-xl bg-secondary max-w-[calc(100svw-1.5rem)] 2xl:max-w-[calc(100svw-4rem)] mx-auto px-4 lg:px-12 py-12 gap-4 xl:gap-12 mb-12">
          <div className="w-full xl:max-w-[1600px] mx-auto">
            <div className="page-header flex flex-col gap-6 w-full lg:w-1/2 mx-auto ms-0">
              <p className="text-md uppercase text-left text-primary">
        ...
        <div className="w-full xl:max-w-[1600px] mx-auto">
          <div className="page-header flex flex-col gap-6 w-full lg:w-1/2 mx-auto ms-0">
            ...
            <p className="text-lg text-white/80">
              Discover residences tailored to your lifestyle preferences and
              find luxury living experiences that match your unique needs.
            </p>
          </div>
        </div>
      </div>
