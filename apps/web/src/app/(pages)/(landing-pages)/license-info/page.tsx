...
export const metadata: Metadata = generatePageMetadata({
  type: 'page',
  data: {
    title: 'License Information | Best Branded Residences | BBR', // Use exactly as in sheet
    description: 'Find license and regulatory information for Best Branded Residences (BBR). Transparency and compliance for our users and partners.', // Use exactly as in sheet
    slug: 'license-info',
    keywords: ['license', 'legal', 'compliance']
  }
})
