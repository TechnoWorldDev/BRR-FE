...
export const metadata: Metadata = generatePageMetadata({
  type: 'page',
  data: {
    title: 'User Agreement | Best Branded Residences | BBR', // Use exactly as in sheet
    description: 'Review the User Agreement of Best Branded Residences (BBR). Understand the terms, conditions, and responsibilities for using our luxury branded residences...', // Use exactly as in sheet
    slug: 'user-agreement',
    keywords: ['user agreement', 'terms', 'legal']
  }
})
