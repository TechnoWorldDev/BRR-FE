        ...
        <SectionLayout>
          <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 xl:gap-16 items-center px-4 py-12 pb-4 lg:pb-0 lg:px-0 lg:py-0 w-full xl:max-w-[1600px] mx-auto">
            <div className="residences-section-header flex flex-col lg:flex-row w-full items-end gap-4 lg:gap-0 xl:max-w-[1600px] mx-auto">
              ...
              <Link href="/directory" className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all bg-primary text-primary-foreground shadow-xs hover:bg-primary/90 h-9 px-4 py-2 has-[>svg]:px-3 w-full lg:w-fit">
                View All Residences
              </Link>
            </div>
          </div>
